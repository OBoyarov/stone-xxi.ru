...
Public Class Main
    ...
    Private Sub GetValDate(ByVal DateStr As Date)
        If Not Execute("exec [dbo].[p_existsday] '" & DateStr.ToString("MM/dd/yyyy") & "'", "Scalar") Then
    ...
    Private Function GetCurrentRate(ByVal reqdatestr As String, ByVal valutestr As String) As String
        Return Execute("select [dbo].[f_get_valute] ('" & reqdatestr & "','" & valutestr & "') as [Valute]", "Scalar").ToString
    End Function
End Class
